...
/// The Target Context names the app the Target belongs to and the title of its window, as part of what Jev reads
/// about the place where the text cursor is. The bundle id is never part of it.
@MainActor
struct AppAndWindowTitleContextTests {
